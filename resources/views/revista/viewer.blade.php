...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="resource" type="application/l10n" href="{{ asset('assets/locale/locale.properties') }}">
    ...
    <script src="{{ asset('assets/js/turn.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('assets/css/pdf-turn.css') }}">
    <script src="{{ asset('assets/js/pdf-turn.js') }}"></script>    
